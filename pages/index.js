      ...
      <main className="bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
              <a href="https://twitter.com/pascalmusabyim1?lang=en">< FaSquareXTwitter/></a>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              ...
              Worked on cool <span className="text-teal-500">startup projects</span> and collaborated with talented people to create digital products for both business and consumer use.
            </p>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              I offer a wide range of services, including web development, mobile app development, and design.
            </p>
          </div>
          <div className="lg:flex gap-10">
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <p className="py-2">
                Do you have an idea for your next great startup? Let's make it a reality.
              </p>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <p className="py-2">
                Are you interested in chasing your dreams? I can help you achieve your dreams as an aspiring entrepreneur.
              </p>
        ...
        <section className="py-10">
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              Since the beginning of my journey as a developer and freelancer, I have created/designed certain
